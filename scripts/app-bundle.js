...
define('text!app.html', ['module'], function(module) { module.exports = "<template><require from=\"./style/main.css\"></require><router-view class=\"${router.isNavigating ? 'navigating' : ''}\"></router-view></template>"; });
